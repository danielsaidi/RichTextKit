...
//
    ...
    open class RichTextCoordinator: NSObject {
        ...
        internal var highlightedRangeOriginalForegroundColor: ColorRepresentable?
            ...
            open func textViewDidChangeSelection(_: UITextView) {
                syncWithTextView()
            }
            ...
            open func textDidBeginEditing(_: Notification) {
            ...
            open func textViewDidChangeSelection(_: Notification) {
                syncWithTextView()
            }

            open func textDidEndEditing(_: Notification) {
